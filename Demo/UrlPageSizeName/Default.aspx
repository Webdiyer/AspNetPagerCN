<%@ Page Title="通过url参数获取每页显示记录数" MetaDescription="该示例演示如何通过url参数来指定AspNetPager分页控件每页显示的记录数。"  Language="C#" MasterPageFile="~/NavPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="UrlPageSizeName_Default" %>
