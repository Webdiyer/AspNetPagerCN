<%@ Page Title="分页导航元素布局" Language="C#" MasterPageFile="AspNetPager.master"  MetaDescription="该示例演示如何设置AspNetPager分页导航元素的布局。" AutoEventWireup="true" CodeFile="PagingButtonLayoutType.aspx.cs" Inherits="PagingButtonLayoutType_Default" %>
