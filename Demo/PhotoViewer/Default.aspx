<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" MetaDescription="该示例演示如何使用AspNetPager分页控件制作图片浏览程序。"  Inherits="PhotoViewer_Default" MasterPageFile="~/navpage.master" Title="AspNetPager示例—图片浏览程序"%>
