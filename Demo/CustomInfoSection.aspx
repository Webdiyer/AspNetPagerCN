<%@ Page Language="C#" MasterPageFile="AspNetPager.master" MetaDescription="该示例演示如何使用AspNetPager分页控件的自定义信息区显示自定义分页信息。"  AutoEventWireup="true" CodeFile="CustomInfoSection.aspx.cs" Inherits="CustomInfoSection_Default" Title="使用自定义信息区" %>
