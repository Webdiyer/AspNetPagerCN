<%@ Page Language="C#" MasterPageFile="~/NavPage.master" MetaDescription="该示例演示如何使用AspNetPager分页控件进行Url逆向分页。"  AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="ReverseUrlPageIndex_Default" Title="Url逆向分页" %>
