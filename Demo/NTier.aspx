<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NTier.aspx.cs" MetaDescription="该示例演示如何在N层结构的web应用程序中使用AspNetPager分页控件。"  Inherits="NTier_Default" MasterPageFile="AspNetPager.master" Title="N层结构分页示例"%>
