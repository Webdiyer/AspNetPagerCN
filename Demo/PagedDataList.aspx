<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PagedDataList.aspx.cs"  MetaDescription="该示例演示如何使用AspNetPager分页控件对DataList控件进行分页。" Inherits="PagedDataList_Default"  MasterPageFile="AspNetPager.master" Title="DataList分页示例"%>
