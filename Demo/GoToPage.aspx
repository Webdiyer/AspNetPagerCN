<%@ Page Title="使用GoToPage方法" Language="C#"  MetaDescription="该示例演示如何以编程方式动态指定要跳转的页面的索引，使用GoToPage方法引发分页事件并跳转到指定页面。" MasterPageFile="AspNetPager.master" AutoEventWireup="true" CodeFile="GoToPage.aspx.cs" Inherits="CurrentPageIndex_Default" %>
